...
stock weapons_Build()
{
    ...
    weapons_Add(.weaponEntityName = "weapon_m4a1_silencer", .weaponName = "M4A1-S",         .weaponType = weapons_type_Primary, .weaponSkinTeam = CS_TEAM_CT,   .weaponDefinitionIndex = 60,   .weaponReloadTime = 3.4, .weaponPerBulletReload = 0,.weaponClipSize = 20,   .weaponOriginalClipSize = 0, .weaponAmmoMax = 40);
